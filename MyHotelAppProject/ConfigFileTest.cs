...
{
    [TestFixture]
    public class ConfigFileTest:HotelApp_BusinessFunctions
    {
        ...
        public void SetupTest()
        {
           ...
           // System.Environment.SetEnvironmentVariable("webdriver.gecko.driver", @"C:\Selenium C#\MyHotelAppProject\packages\Selenium.WebDriver.GeckoDriver.Win64.0.16.0\driver\geckodriver.exe");
