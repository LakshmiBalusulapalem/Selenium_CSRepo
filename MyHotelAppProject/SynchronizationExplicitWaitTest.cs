...
{
    [TestFixture]
    public class SynchronizationExplicitWaitTest:HotelApp_BusinessFunctions
    {
        ...
        [Test]
        public void MySynchronizationExplicitWaitTest ()
        {
            ...
            //myWait.Until(ExpectedConditions.ElementIsVisible(By.Id(ConfigurationManager.AppSettings["Btn_BookingHotel_Logout"])));
            ...
            //Step added after Book Now button click  
            HA_GF_WaitForElementPresent(driver, By.Id(ConfigurationManager.AppSettings["Btn_BookingHotel_Logout"]), 10);
            String strOrderNo = driver.FindElement(By.Id(ConfigurationManager.AppSettings["Txt_BookingHotel_OrderNo"])).GetAttribute("value");
            Console.WriteLine("Order Number Generate is " + strOrderNo);
