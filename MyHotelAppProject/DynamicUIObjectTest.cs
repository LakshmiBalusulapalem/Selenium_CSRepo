...
{
    [TestFixture]
    public class DynamicUIObjectTest:HotelApp_BusinessFunctions
    {
        ...
        [Test]
        public void MyDynamicUIObjectTest ()
        {
            ...
            //My Itenary button click
            driver.FindElement(By.Id(ConfigurationManager.AppSettings["Btn_BookingHotel_MyItinerary"])).Click();
            //Search for booked itenary for the given order id
            //driver.FindElement(By.Id(ConfigurationManager.AppSettings["Txt_BookedItinerary_SearchOrderid"])).SendKeys(strOrderNo);
            //driver.FindElement(By.Id(ConfigurationManager.AppSettings["Btn_BookedItinerary_Go"])).Click();
